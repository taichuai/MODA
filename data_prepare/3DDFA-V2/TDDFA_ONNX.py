...
class TDDFA_ONNX(object):
    ...
    def __init__(self, **kvs):
        ...
        self.bfm_session = onnxruntime.InferenceSession(bfm_onnx_fp, None, providers=['CPUExecutionProvider'])
        ...
        self.session = onnxruntime.InferenceSession(onnx_fp, None, providers=['CPUExecutionProvider'])

...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        ## dataset settings
        self.parser.add_argument('--dataset_names'         , type=str, default='WRA_CathyMcMorrisRodgers1_000', help='chooses how datasets are loaded.'),
        self.parser.add_argument('--cand_dataset_names'    , type=str, default='WRA_CathyMcMorrisRodgers1_000', help='for loading candidate images'),
        self.parser.add_argument('--dataset_type'          , type=str, default='Train'                        , help='[Train or Val]'),
        self.parser.add_argument('--train_dataset_names'   , type=str, default='train_pix_list.txt'),
        self.parser.add_argument('--validate_dataset_names', type=str, default='val_pix_list.txt'),
        self.parser.add_argument('--train_sub_names'       , type=str, default='May     , Obama'     , help='chooses train datasets.')
        self.parser.add_argument('--subject_name'          , type=str, default='May     , Obama'     , help='chooses train datasets.')
        self.parser.add_argument('--test_sub_names'        , type=str, default='May-test, Obama-test', help='chooses validation datasets.')
        self.parser.add_argument('--ref_sub_names'         , type=str, default='May     , Obama'     , help='chooses reference datasets.')
        ...
        self.parser.add_argument('--n_epochs'        , type=int           , default=20         , help='number of epochs')                                           
        ...
        self.parser.add_argument('--num_D'           , type=int           , default=3                                   , help='number of patch scales in each discriminator')
        self.parser.add_argument('--n_layers_D'      , type=int           , default=4                                   , help='number of layers in discriminator')
        ...
        self.parser.add_argument('--lambda_Freq', type=float, default=0.0  , help='weight for temporal loss')
